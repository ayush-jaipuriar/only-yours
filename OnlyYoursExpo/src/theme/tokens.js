...
const lightColors = {
  backgroundBase: '#FAEEF3',
  backgroundMuted: '#F3E3EB',
  backgroundCanvas: '#EBD7E2',
  surface: '#FFF8FA',
  surfaceMuted: '#F7EAF0',
  surfaceElevated: '#EEDDE7',
  surfaceOverlay: '#F4E4EC',
  surfaceInput: '#F8ECF2',
  surfaceEmphasis: '#E6D2DE',
  border: '#D9BCCB',
  borderStrong: '#BA94A8',
  borderAccent: '#C9799A',
  textPrimary: '#23172E',
  ...
  danger: '#C44D69',
  info: '#557FD8',
  overlayScrim: 'rgba(35, 23, 46, 0.16)',
  glowPrimary: 'rgba(255, 46, 110, 0.28)',
  glowAccent: 'rgba(232, 90, 135, 0.22)',
  bannerWarning: '#FFF0E1',
  bannerWarningBorder: '#D9964A',
  bannerDanger: '#FFE7EC',
  bannerDangerBorder: '#D75B7C',
  celebrationSurface: '#F1DCE7',
  celebrationBorder: '#D26C93',
